...
![Distribuição de Status dos Pedidos](distribuicao_status_pedidos.png)
...
![Evolução Mensal do Faturamento](evolucao_mensal_faturamento.png)
...
![Faturamento por Categoria](faturamento_categoria.png)
